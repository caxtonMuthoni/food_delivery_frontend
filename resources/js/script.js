$(document).ready(function() {
    ...
    $('.mobile-nav-icon').click(function(){
        var activeIcon = $('.mobile-nav-icon .active-icon')
        $('.js--main-nav').slideToggle(200)
        if(activeIcon.hasClass('icon-menu')){
            $('.icon-menu').removeClass('active-icon')
            $('.icon-close').addClass('active-icon')
        }else{
            $('.icon-menu').addClass('active-icon')
            $('.icon-close').removeClass('active-icon')
        }
    })
})